...
public class tempCategoryGenerate implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if(categoryRepository.selectCategoryCount()!=49){
            ...
            Category 이용안내 = categoryService.createNewCategoryWithParentCategory("이용안내", 도서관_안내);
            categoryService.createNewCategoryWithParentCategory("시설안내", 도서관_안내);

            Category 통합자료_검색 = categoryService.createNewCategoryWithParentCategory("통합자료 검색", 자료_검색);
            ...
            Category 나의_도서관 = categoryService.createNewCategoryWithParentCategory("나의 도서관", 내_서재);
            categoryService.createNewCategoryWithParentCategory("결제내역", 내_서재);
            Category 회원정보 = categoryService.createNewCategoryWithParentCategory("회원정보", 내_서재);
            ...
            categoryService.createNewCategoryWithParentCategory("이용시간", 이용안내);
            categoryService.createNewCategoryWithParentCategory("도서관 달력", 이용안내);

            categoryService.createNewCategoryWithParentCategory("간략 검색", 통합자료_검색);
            categoryService.createNewCategoryWithParentCategory("상세 검색", 통합자료_검색);

            Category 도서현황 = categoryService.createNewCategoryWithParentCategory("도서현황", 나의_도서관);
            Category 예약_및_신청 = categoryService.createNewCategoryWithParentCategory("예약 및 신청", 나의_도서관);
            categoryService.createNewCategoryWithParentCategory("즐겨찾기", 나의_도서관);

            categoryService.createNewCategoryWithParentCategory("내 정보", 회원정보);
            categoryService.createNewCategoryWithParentCategory("정보수정", 회원정보);
            categoryService.createNewCategoryWithParentCategory("내 글 관리", 회원정보);
            categoryService.createNewCategoryWithParentCategory("비밀번호 변경", 회원정보);
            categoryService.createNewCategoryWithParentCategory("회원탈퇴", 회원정보);

            // 레벨 4 카테고리 생성
            categoryService.createNewCategoryWithParentCategory("대출중인 도서", 도서현황);
            categoryService.createNewCategoryWithParentCategory("이전 대출내역", 도서현황);
            categoryService.createNewCategoryWithParentCategory("예약내역", 도서현황);
            categoryService.createNewCategoryWithParentCategory("신청내역", 도서현황);

            categoryService.createNewCategoryWithParentCategory("좌석 예약현황", 예약_및_신청);
            categoryService.createNewCategoryWithParentCategory("공간 예약현황", 예약_및_신청);
            categoryService.createNewCategoryWithParentCategory("클래스 신청현황", 예약_및_신청);

            categoryService.createNewCategoryWithParentCategory("게시글", 회원정보);
            categoryService.createNewCategoryWithParentCategory("댓글", 회원정보);
        }
